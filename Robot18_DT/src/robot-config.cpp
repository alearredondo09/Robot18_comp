...
motor RightDriveA = motor(PORT9, ratio18_1, false); 
motor RightDriveB = motor(PORT10, ratio18_1, false);
...
bool driveForward = true; // Variable para controlar la dirección del motor
